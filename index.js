...
pizza.cost+=thickCrustUpcharge
  ...
  var extraCheese = document.querySelector('input[name="extraCheese"]:checked').value; console.log("extraCheese="+cheese);
	var cheesePrice = 0;
	if (cheese === "Extra") {
	{
    alert (True)
	...
	}; console.log(`pizza.cost.${cheesePrice}`);
 ...
 alert("delivery")
  ...
  if (pizza.saleType =+ 13.5) {
    document.getElementById("demo").innerHTML = "pizza.cost";
  }
